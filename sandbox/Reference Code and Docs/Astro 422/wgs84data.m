...
%%         EEarth J2 J3 J4 GMM GMS AU HalfPI TwoPI Zero_IE Small
%%
...
%%  Earth Characteristics from WGS 84 
      ...
      RE=6378.137; 						%% km                 ***
      OmegaEarth=0.00007292115;      %% rad/sec     ***
      SidePerSol=OmegaEarth*86400/(2*pi);  	    %% Sidereal Days/Solar Day
      RadPerDay=OmegaEarth*86400;    	          %% rad/day
